...
public class Fighter2Controller implements KeyListener {
   ...
   public Fighter2Controller(Fighter c, Fighter opp, Shield shield, MovableCharacter mc) {
      this.fighter = c;
      this.opponent = opp;
   ...
   public void keyPressed(KeyEvent e) {
      ...
      if (!this.isKeyPressed) {
         if (e.getKeyCode() == KeyEvent.VK_L && !downSlamTimer.isRunning() && fighter.getY() < 180) {
            startDownSlamTimer();
         }
         if (e.getKeyCode() == KeyEvent.VK_I && System.currentTimeMillis() - timeOfLastBasicAttack > 1200) {
         ...
         else if (e.getKeyCode() == KeyEvent.VK_P && System.currentTimeMillis() - timeOfLastRangedAttack > 1500) {
