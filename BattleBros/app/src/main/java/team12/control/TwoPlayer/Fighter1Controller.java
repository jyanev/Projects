...
public class Fighter1Controller implements KeyListener {
   ...
   public Fighter1Controller(Fighter c, Fighter opp, Shield shield, MovableCharacter mc) {
      this.fighter = c;
      this.opponent = opp;
   ...
   public void keyPressed(KeyEvent e) {
      ...
      if (!this.isKeyPressed) {
         ...
         if (e.getKeyCode() == KeyEvent.VK_Q && System.currentTimeMillis() - timeOfLastBasicAttack > 1200) {
         ...
         else if (e.getKeyCode() == KeyEvent.VK_E && System.currentTimeMillis() - timeOfLastRangedAttack > 1500) {
